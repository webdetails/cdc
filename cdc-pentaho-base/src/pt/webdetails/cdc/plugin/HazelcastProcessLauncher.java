...
public class HazelcastProcessLauncher implements IHazelcastLauncher {
  ...
  public HazelcastProcessLauncher() {
  }
  ...
  public void start() {
    ...
    try {
      ...
      logger
          .error(
              "launchProcess: " + getHazelcastStandaloneConfigFile() + " not found! Creating from current config." );
  ...
  //      config = configBuilder.build();
  //    } catch (FileNotFoundException e1) {
  //      logger.error("launchProcess: " + getHazelcastStandaloneConfigFile() + " not found! Creating from current
  // config.");
  //      config = HazelcastConfigHelper.cloneConfig(HazelcastManager.INSTANCE.getHazelcast().getConfig());
  //      HazelcastConfigHelper.saveConfig(config, getHazelcastStandaloneConfigFile());
  //    }
